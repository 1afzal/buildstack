...
export type BuildStackAction = FileAction | ShellAction | StartAction | BuildAction | SupabaseAction;

export type BuildStackActionData = BuildStackAction | BaseAction;
