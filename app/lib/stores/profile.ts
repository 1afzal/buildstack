...
const storedProfile = typeof window !== 'undefined' ? localStorage.getItem('buildstack_profile') : null;
...
export const updateProfile = (updates: Partial<Profile>) => {
  ...
  if (typeof window !== 'undefined') {
    localStorage.setItem('buildstack_profile', JSON.stringify(profileStore.get()));
  }
};
