      ...
      <div className="p-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className={classNames(feature.icon, 'w-5 h-5 text-buildstack-elements-textSecondary')} />
            <div className="flex items-center gap-2">
              <h4 className="font-medium text-buildstack-elements-textPrimary">{feature.title}</h4>
              {feature.beta && (
        ...
        <p className="mt-2 text-sm text-buildstack-elements-textSecondary">{feature.description}</p>
        {feature.tooltip && <p className="mt-1 text-xs text-buildstack-elements-textTertiary">{feature.tooltip}</p>}
      </div>
    </motion.div>
  ),
);
...
const FeatureSection = memo(
  ({
    ...
    >
      <div className="flex items-center gap-3">
        <div className={classNames(icon, 'text-xl text-gray-900')} />
        <div>
          <h3 className="text-lg font-medium text-buildstack-elements-textPrimary">{title}</h3>
          <p className="text-sm text-buildstack-elements-textSecondary">{description}</p>
        </div>
      </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <select
            ...
            className={classNames(
              ...
              'group-hover:border-gray-900/30',
              'transition-all duration-200',
            )}
          >
