...
<artifact_info>
  ...
  - Use \`<buildstackArtifact>\` tags with \`title\` and \`id\` attributes
  - Use \`<buildstackAction>\` tags with \`type\` attribute:
    - shell: Run commands
...
## Artifact Usage
22. Use \`<buildstackArtifact>\` tags with \`title\` and \`id\` attributes for each project
23. Use \`<buildstackAction>\` tags with appropriate \`type\` attribute:
