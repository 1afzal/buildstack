...
export class WorkbenchStore {
  ...
  get buildstackTerminal() {
    return this.#terminalStore.buildstackTerminal;
  }
  get alert() {
  ...
  attachBuildStackTerminal(terminal: ITerminal) {
    this.#terminalStore.attachBuildStackTerminal(terminal);
  }
