...
export const DropdownItem = ({ children, onSelect, className }: DropdownItemProps) => (
  <DropdownMenu.Item
    className={classNames(
      ...
      'text-buildstack-elements-textPrimary hover:text-buildstack-elements-textPrimary',
...
export const DropdownSeparator = () => (
  <DropdownMenu.Separator className="h-px bg-buildstack-elements-borderColor my-1" />
);
