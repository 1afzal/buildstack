...
const GRADIENT_COLORS = [
  'from-gray-900/10 to-blue-500/5',
  ...
  'from-pink-500/10 to-gray-900/5',
];
  ...
  return (
    <motion.div
      className={classNames(
        ...
        gradientClass,
        borderEffect
          ? 'border border-buildstack-elements-borderColor dark:border-buildstack-elements-borderColor-dark hover:border-gray-900/40'
          : '',
