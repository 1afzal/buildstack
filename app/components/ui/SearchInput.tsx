      ...
      <div className={classNames('relative flex items-center w-full', containerClassName)}>
        ...
        <div
          className={classNames(
            'absolute left-3 top-1/2 -translate-y-1/2 text-buildstack-elements-textTertiary',
            iconClassName,
          )}
        >
          {loading ? (
        ...
        <AnimatePresence>
          {hasValue && showClearButton && (
            <motion.button
              ...
              type="button"
              onClick={onClear}
              className="absolute right-3 top-1/2 -translate-y-1/2 text-buildstack-elements-textTertiary hover:text-buildstack-elements-textSecondary p-1 rounded-full hover:bg-buildstack-elements-background-depth-2"
