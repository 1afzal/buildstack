      ...
      >
        <div
          className={classNames(
            ...
            'p-1 rounded-lg text-buildstack-elements-item-contentAccent',
            'flex ',
          )}
        >
          ...
          <motion.button
            ...
            className=" p-1 rounded-lg bg-buildstack-elements-item-backgroundAccent hover:bg-buildstack-elements-artifacts-backgroundHover"
