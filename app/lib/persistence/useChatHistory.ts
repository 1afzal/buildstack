            ...
            if (startingIdx > 0) {
              ...
              filteredMessages = [
                ...
                },
                {
                  ...
                  content: `BuildStack restored your chat from a snapshot. You can revert this message to load the full chat history.
                  <buildstackArtifact id="restored-project-setup" title="Restored Project & Setup" type="bundled">
                  ${Object.entries(snapshot?.files || {})
                    .map(([key, value]) => {
                      if (value?.type === 'file') {
                        return `
                      <buildstackAction type="file" filePath="${key}">
${value.content}
                      </buildstackAction>
                      `;
                      } else {
