...
export default function ChatAlert({ alert, clearAlert, postMessage }: Props) {
  ...
  const message = isPreview
    ? 'We encountered an error while running the preview. Would you like BuildStack to analyze and help resolve this issue?'
    : 'We encountered an error while running terminal commands. Would you like BuildStack to analyze and help resolve this issue?';
    ...
    <AnimatePresence>
      ...
      >
        <div className="flex items-start">
          ...
          >
            <div className={`i-ph:warning-duotone text-xl text-buildstack-elements-button-danger-text`}></div>
          </motion.div>
          {/* Content */}
