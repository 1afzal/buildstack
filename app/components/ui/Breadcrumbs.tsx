      ...
      <div className="flex items-center gap-1.5">
        ...
        <span
          className={classNames(
            isLast
              ? 'font-medium text-buildstack-elements-textPrimary dark:text-buildstack-elements-textPrimary-dark'
              : 'text-buildstack-elements-textSecondary dark:text-buildstack-elements-textSecondary-dark hover:text-buildstack-elements-textPrimary dark:hover:text-buildstack-elements-textPrimary-dark',
            ...
            <li key={index} className="flex items-center">
              ...
              {!isLast && (
                <span
                  className={classNames(
                    separator,
                    'w-3 h-3 mx-1 text-buildstack-elements-textTertiary dark:text-buildstack-elements-textTertiary-dark',
                  )}
                />
              )}
            </li>
