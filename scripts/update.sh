...
echo "Starting BuildStack update process..."
...
LATEST_RELEASE_URL=$(curl -s https://api.github.com/repos/buildstack-ai/buildstack/releases/latest | grep "browser_download_url.*zip" | cut -d : -f 2,3 | tr -d \")
