...
export function WebSearch({ onSearchResult, disabled = false }: WebSearchProps) {
  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      >
        {isSearching ? (
          <div className="i-svg-spinners:90-ring-with-bg text-buildstack-elements-loader-progress text-xl animate-spin" />
        ) : (
      ...
      {isOpen && (
        <div
          className={classNames(
            ...
            'rounded-lg border border-buildstack-elements-borderColor bg-buildstack-elements-background-depth-2 p-2 shadow-lg',
          )}
        >
          <input
            ref={inputRef}
            ...
            className={classNames(
              ...
              'bg-buildstack-elements-background-depth-1 text-buildstack-elements-textPrimary',
              'placeholder-buildstack-elements-textTertiary',
          ...
          <button
            ...
            className={classNames(
              ...
              'bg-buildstack-elements-button-primary-background text-buildstack-elements-button-primary-text',
