...
describe('StreamingMessageParser', () => {
  ...
  describe('no artifacts', () => {
    ...
    ])('should correctly parse chunks and strip out buildstack artifacts (%#)', (input, expected) => {
  ...
  describe('invalid or incomplete artifacts', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      ...
      ['Foo bar <bol', 'Foo bar '],
      ['Foo bar <buildstack', 'Foo bar '],
      ['Foo bar <buildstacka', 'Foo bar <buildstacka'],
      ['Foo bar <buildstackA', 'Foo bar '],
      ['Foo bar <buildstackArtifacs></buildstackArtifact>', 'Foo bar <buildstackArtifacs></buildstackArtifact>'],
      ['Before <oltArtfiact>foo</buildstackArtifact> After', 'Before <oltArtfiact>foo</buildstackArtifact> After'],
      [
        'Before <buildstackArtifactt>foo</buildstackArtifact> After',
        'Before <buildstackArtifactt>foo</buildstackArtifact> After',
      ],
    ])('should correctly parse chunks and strip out buildstack artifacts (%#)', (input, expected) => {
      runTest(input, expected);
  ...
  describe('valid artifacts without actions', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      [
        'Some text before <buildstackArtifact title="Some title" id="artifact_1">foo bar</buildstackArtifact> Some more text',
        {
      ...
      [
        [
          'Some text before <buildstackArti',
          'fact',
          ' title="Some title" id="artifact_1" type="bundled" >foo</buildstackArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        [
          ...
          ' ',
          '>',
          'foo</buildstackArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        [
          ...
          ' >fo',
          'o</buildstackArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        [
          ...
          'o',
          '<',
          '/buildstackArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        'Before <buildstackArtifact title="Some title" id="artifact_1">foo</buildstackArtifact> After',
        {
          output: 'Before  After',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
        },
  ...
  describe('valid artifacts with actions', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      [
        'Before <buildstackArtifact title="Some title" id="artifact_1"><buildstackAction type="shell">npm install</buildstackAction></buildstackArtifact> After',
        {
          output: 'Before  After',
      ...
      [
        'Before <buildstackArtifact title="Some title" id="artifact_1"><buildstackAction type="shell">npm install</buildstackAction><buildstackAction type="file" filePath="index.js">some content</buildstackAction></buildstackArtifact> After',
        {
          output: 'Before  After',
