...
// Create a custom hook to connect to the buildstackHistory database
function useBuildStackHistoryDB() {
...
export function DataTab() {
  // Use our custom hook for the buildstackHistory database
  const { db, isLoading: dbLoading } = useBuildStackHistoryDB();
  ...
  // Data operations hook with buildstackHistory database
  const {
    isExporting,
    isImporting,
    isResetting,
    ...
    customDb: db || undefined, // Pass the buildstackHistory database, converting null to undefined
  ...
  useEffect(() => {
    if (db) {
      console.log('Loading chats from buildstackHistory database', {
        name: db.name,
        version: db.version,
  ...
  return (
    <div className="space-y-12">
      ...
      {/* Chats Section */}
      <div>
        <h2 className="text-xl font-semibold mb-4 text-buildstack-elements-textPrimary">Chats</h2>
        {dbLoading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <Card>
              <CardHeader>
                <div className="flex items-center mb-2">
                  ...
                  <CardTitle className="text-lg group-hover:text-buildstack-elements-item-contentAccent transition-colors">
                    Export All Chats
                  </CardTitle>
                </div>
                ...
                <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }} className="w-full">
                  <Button
                    ...
                    className={classNames(
                      'hover:text-buildstack-elements-item-contentAccent hover:border-buildstack-elements-item-backgroundAccent hover:bg-buildstack-elements-item-backgroundAccent transition-colors w-full justify-center',
            ...
            <Card>
              <CardHeader>
                <div className="flex items-center mb-2">
                  <motion.div
                    className="text-buildstack-elements-button-danger-text mr-2"
      ...
      {/* Settings Section */}
      <div>
        <h2 className="text-xl font-semibold mb-4 text-buildstack-elements-textPrimary">Settings</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <Card>
            <CardHeader>
              <div className="flex items-center mb-2">
      ...
      {/* API Keys Section */}
      <div>
        <h2 className="text-xl font-semibold mb-4 text-buildstack-elements-textPrimary">API Keys</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <Card>
            <CardHeader>
              <div className="flex items-center mb-2">
      ...
      {/* Data Visualization */}
      <div>
        <h2 className="text-xl font-semibold mb-4 text-buildstack-elements-textPrimary">Data Usage</h2>
        <Card>
